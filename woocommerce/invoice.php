...
final class RY_WEZI_WC_Invoice extends RY_WEZI_Model
{
    ...
    public function auto_get_invoice($order_ID)
    {
        ...
        WC()->queue()->schedule_single(time() + 10, RY_WEZI::OPTION_PREFIX . 'auto_get_invoice', [$order_ID], '');
    }
    ...
    public function auto_delete_invoice($order_ID)
    {
        ...
        if ($invoice_number) {
            if ('zero' == $invoice_number) {
                ...
                WC()->queue()->schedule_single(time() + 10, RY_WEZI::OPTION_PREFIX . 'auto_invalid_invoice', [$order_ID], '');
            }
        }
    }
