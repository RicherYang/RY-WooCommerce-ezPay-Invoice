 ...
 *
 * HOWEVER, on occasion RY ezPay Invoice for WooCommerce will need to update template files and you
...
<div class="woocommerce-invoice-fields">
    <h3><?php esc_html_e('Invoice info', 'ry-woocommerce-ezpay-invoice'); ?>
    </h3>
